              ...
              <div className="pointer-events-none fixed inset-y-0 left-0 flex max-w-full pr-10">
                ...
                >
                  <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                    <div className="flex h-full flex-col overflow-hidden bg-white py-6 shadow-xl dark:bg-slate-700">
                                ...
                                {sidebarOptions.map((option) => {
                                  ...
                                  return (
                                    <li key={option.name}>
                                      ...
                                      >
                                        <span className="text-gray-400 border-gray-200 group-hover:border-indigo-600 group-hover:text-indigo-600 dark:text-indigo-800 dark:group-hover:text-indigo-800 flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border text-[0.625rem] font-medium bg-white">
